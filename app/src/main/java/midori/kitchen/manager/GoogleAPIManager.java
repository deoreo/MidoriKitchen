...
public class GoogleAPIManager {
    ...
    private static final String API_KEY = "AIzaSyAHSIjLkUABvce1psAveGWwFOqSNJ6AT1A";
    ...
    public static ArrayList autocomplete(String input) {
        ...
        try {
            ...
            for (int i = 0; i < predsJsonArray.length(); i++) {
                ...
                resultList.add(new PlaceModel(placeId, descSplit[0], description));
    ...
    public static GeocodeModel geocode(String address) {
        GeocodeModel modelGeocode = null;
        HttpURLConnection conn = null;
        StringBuilder jsonResults = new StringBuilder();
        ...
        try {
            ...
            for (int i = 0; i < resultsJsonArray.length(); i++) {
                ...
                modelGeocode = new GeocodeModel(lat, lon);
